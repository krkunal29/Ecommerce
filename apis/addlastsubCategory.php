...
if(isset($_POST['category']) && isset($_POST['categoryId']) ){
    $query = "INSERT INTO lastsubcategorymaster( lastsubcategoryName, innersubcategoryId) VALUES
    ('$category','$categoryId')";
...
if($jobQuery==1)
    {
        ...
        $s = strval($last_id);
        $sql = "SELECT lscm.lastsubcategoryId,lscm.lastsubcategoryName,
      ...
      lscm.innersubcategoryId =iscm.innersubcategoryId
         WHERE lscm.lastsubcategoryId= $s";
    ...
    $response = array('Message'=>"All Last Sub  Category Data fetched Successfully","Data"=>$records ,'Responsecode'=>200);
		}else{
