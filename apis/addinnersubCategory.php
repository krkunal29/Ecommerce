...
if(isset($_POST['category']) && isset($_POST['categoryId']) ){
    $query = "INSERT INTO innersubcategorymaster( innersubcategoryName, subcategoryId) VALUES
    ('$category','$categoryId')";
...
if($jobQuery==1)
    {
        ...
        $s = strval($last_id);
        $sql = "SELECT iscm.innersubcategoryId,iscm.innersubcategoryName,iscm.subcategoryId,
        scm.subcategoryName from innersubcategorymaster iscm
         ...
         WHERE iscm.innersubcategoryId = $s";
    ...
    $response = array('Message'=>"All Sub Inner Category Data fetched Successfully","Data"=>$records ,'Responsecode'=>200);
		}else{
