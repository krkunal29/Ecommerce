                        ...
                        <div class="row blogcategorylist">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                      <div class="col-md-12">
                                        <div class="row">
                                          ...
                                          <div class="col-sm-4">
                                            <button type="button" class="btn btn-primary" style="float: right;" onclick="addBlogcategory();" >New Blog Category</button>
                                          </div>
                                        </div>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        <table  class="table" id="blogcategorys">
                                            <thead>
                                                <tr>
                                                    <th>Blog Category</th>
                                                    <th class="nosort">&nbsp;</th>
