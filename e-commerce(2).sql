...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 08, 2019 at 12:12 PM
...
(2, 'Astronomy Binoculars A Great Alternative', 'MCSE boot camps have its supporters and its detractors. Some people do not understand why you should have to spend money on boot camp when you can get the MCSE study materials yourself at a fraction.', 3, '0', 'http://www.youtube.com', '2019-12-03 21:20:53', '2019-12-03 21:20:53'),
...
--
ALTER TABLE `transaction_details`
  MODIFY `tDetailId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
