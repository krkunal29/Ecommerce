...
if (isset($_POST['userId']) && isset($_POST['postId']) && isset($_POST['commentText'])) {
    
    $commentText   = mysqli_real_escape_string($conn, $commentText);
   
    $query    = "INSERT INTO post_comments(postId,userId,commentText) VALUES('$postId','$userId','$commentText')";
    ...
    if ($jobQuery == 1) {
        ...
        FROM post_comments pc INNER JOIN customer_master cm ON cm.customerId = pc.userId  WHERE pc.commentId = $s";
