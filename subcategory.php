        ...
        <div class="wrapper">
            ...
            <div class="page-wrap">
                                    ...
                                    <div class="card-header">
                                      <div class="col-md-12">
                                        <div class="row">
                                          ...
                                          <div class="col-sm-4">
                                            <button type="button" class="btn btn-primary" style="float: right;" onclick="addsubCategory();" >New Sub Category</button>
                                          </div>
                                        </div>
                                        </div>
               ...
               <?php include "dashboardmodal.php"; ?>
                ...
                <script src="jscode/subCategory.js"></script>
