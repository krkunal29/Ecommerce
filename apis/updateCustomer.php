...
$records  = null;
extract($_POST);
if (isset($_POST['userId']) && isset($_POST['custName']) && isset($_POST['contactNumber'])&& isset($_POST['custState']) && isset($_POST['custCity']) && isset($_POST['pincode'])  && isset($_POST['billingAddress'])) {
    ...
    $custName          = mysqli_real_escape_string($conn, $custName);
     ...
     $sql   = "UPDATE customer_master SET custName = '$custName',contactNumber = '$contactNumber',alternateContact = '$alternateContact',
      alternateContact1 = '$alternateContact1', peek = '$peek',billingAddress = '$billingAddress',shippingAddress = '$shippingAddress',
      custState = $custState,custCity = $custCity,pincode = '$pincode', water = '$water' WHERE customerId = $userId";
